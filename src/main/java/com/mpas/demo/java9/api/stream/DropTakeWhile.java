package com.mpas.demo.java9.api.stream;

import java.util.List;
import java.util.concurrent.atomic.AtomicBoolean;
import java.util.stream.Stream;

import static com.mpas.demo.java9.api.stream.DropTakeWhile.Priority.ERROR;
import static com.mpas.demo.java9.api.stream.DropTakeWhile.Priority.INFO;
import static com.mpas.demo.java9.api.stream.DropTakeWhile.Priority.WARNING;
