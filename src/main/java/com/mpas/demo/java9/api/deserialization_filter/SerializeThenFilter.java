package com.mpas.demo.java9.api.deserialization_filter;
...
import static com.mpas.demo.java9.api.deserialization_filter.LinkedListNode.createList;
...
public class SerializeThenFilter {
	...
	private static void staticDeserializationFilter() throws IOException, ClassNotFoundException {
		LinkedListNode list = LinkedListNode.createList("A", "B", "C", "D", "E", "F", "G", "H");
	...
	private static void dynamicDeserializationFilter() throws IOException, ClassNotFoundException {
		LinkedListNode list = LinkedListNode.createList("AAA", "BBB", "CCC");
		System.out.println("List to serialize: " + list);
